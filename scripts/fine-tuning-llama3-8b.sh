...
lora_rank=8
lora_alpha=32
lora_trainable="gate_proj,down_proj,up_proj"  # Llama3 standard target modules
lora_dropout=0.1                 
pretrained_model="./checkpoints/llama-3.1-8b"  # Use Llama3.1-8B model
tokenizer_path="./checkpoints/llama-3.1-8b"
dataset_dir="./data/dolly"
validation_file="./data/dolly/valid.json"
per_device_train_batch_size=1
per_device_eval_batch_size=1
gradient_accumulation_steps=4
max_seq_length=512
output_dir="./outputs"
exp_name="sft_llama3-8b_5epoch"

lora_b_nums=4  # Number of multiple LoRAs in HydraLoRA
